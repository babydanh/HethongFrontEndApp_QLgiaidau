...
class _AdminDisputesScreenState extends ConsumerState<AdminDisputesScreen> {
      ...
      data: (disputes) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, i) =>
              _buildDisputeCard(context, filtered[i], colors),
        );
      },
  ...
  Widget _buildDisputeCard(
    ...
    final tournamentName =
        dispute['tournament']?['name']?.toString() ??
        dispute['tournamentName']?.toString() ??
        '---';
    final createdBy =
        dispute['createdBy']?['fullName']?.toString() ??
        (l10n!.adminDisputesUserFallback);
      ...
      child: Column(
        ...
        children: [
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      reason.isNotEmpty
                          ? reason
                          : (l10n!.adminDisputesReasonFallback),
                      style: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w700,
                        color: colors.textPrimary,
          ...
          if (createdAt.isNotEmpty) ...[
            ...
            Text(
              l10n!.adminDisputesCreatedAt(createdAt.substring(0, 10)),
...
final _adminDisputesProvider = FutureProvider<List<Map<String, dynamic>>>((
  ref,
) async {
  final dio = ref.read(dioProvider);
